...
| `AWG_SNAPSHOT_RETENTION_DAYS` | `31` | Snapshot retention window in days (0 to disable cleanup). In-window snapshots are kept, plus one older baseline snapshot per peer for accurate usage deltas. |
